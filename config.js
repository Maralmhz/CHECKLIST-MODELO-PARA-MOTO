// ============================================
// CONFIG.JS - TEMPLATE PARA MOTOCICLETAS
// ============================================
...
window.OFICINA_CONFIG = {
    ...
    nome: "OFICINA DE MOTOS",                           // Nome principal
    subtitulo: "CHECKLIST DE ENTRADA E INSPEÇÃO",       // Subtítulo header
    cnpj: "00.000.000/0000-00",                         // CNPJ
    oficinaId: "oficina_motos_demo",                    // ID da oficina no Firebase (ex: oficina_motos_do_joao)
